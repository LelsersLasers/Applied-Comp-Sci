...
walls.push(new Thing(new Vector(50, 50), "#ff0000", 5, 500, 2));
...
walls.push(new Thing(new Vector(400, 50), "#ff0000", 200, 5, 1));

walls.push(new Thing(new Vector(250, 50), "#ff0000", 5, 450, 2));
walls.push(new Thing(new Vector(250, 550), "#ff0000", 300, 5, 1));

walls.push(new Thing(new Vector(300, 50), "#ff0000", 5, 450, 2));
walls.push(new Thing(new Vector(350, 50), "#ff0000", 5, 450, 2));
walls.push(new Thing(new Vector(400, 50), "#ff0000", 5, 450, 2));

walls.push(new Thing(new Vector(550, 50), "#ff0000", 5, 505, 2));


var endBlock = new Thing(new Vector(595, 520), "#00ff00", 5, 50);
